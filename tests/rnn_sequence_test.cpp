...
int main() {
    ...
    // Verify weights on host to catch misinit early
    {
    ...
    // Ensure hidden state after step 1 is correct before using it
    ...
    // Verify hidden state after step 2 before moving on
    ...
    // Verify hidden state after reset before final check
