...
namespace Thot {
    ...
    public:
        ...
        static std::shared_ptr<Attention> MHA(int embed_dim, int num_heads,
...
namespace Thot {
    inline std::shared_ptr<Attention> Attention::MHA(int embed_dim, int num_heads, Initialization weight_init, const std::string& name) { return std::make_shared<MHAAtt>(embed_dim, num_heads, weight_init, name);}
} // namespace Thot