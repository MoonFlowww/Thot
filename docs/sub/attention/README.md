...
The `Thot::Attention` namespace provides descriptors that plug into transformer
...
`Thot::Attention::Details`.

## Descriptor: `Thot::Attention::MultiHead(...)`
...
## Runtime Module: `Thot::Attention::Details::MultiHeadAttention`

The descriptor is materialised into a LibTorch module through
`Thot::Attention::Details::MultiHeadAttention`. The module validates the option
