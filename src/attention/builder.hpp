#ifndef Nott_ATTENTION_BUILDER_HPP
#define Nott_ATTENTION_BUILDER_HPP
...
namespace Nott::Attention::Details {
    ...
    AttentionModule register_attention(Module& module,
                                       ...
                                       ::Nott::Attention::Descriptor descriptor)
    {
        return std::visit(
            [&](auto&& attention_descriptor) -> AttentionModule {
                using Descriptor = std::decay_t<decltype(attention_descriptor)>;
                if constexpr (std::is_same_v<Descriptor, ::Nott::Attention::MultiHeadDescriptor>) {
                    ::Nott::Attention::Details::MultiHeadAttentionOptions attention_options{};
                    ...
                    return module.register_module(name,
                                                  ::Nott::Attention::Details::MultiHeadAttention(attention_options));
                } else if constexpr (std::is_same_v<Descriptor, ::Nott::Attention::MultiHeadLatentDescriptor>) {
                    ::Nott::Attention::Details::MultiHeadLatentAttentionOptions attention_options{};
                    attention_options.embed_dim = attention_descriptor.options.embed_dim;
                    attention_options.num_heads = attention_descriptor.options.num_heads;
                    ...
                    return module.register_module(
                        name, ::Nott::Attention::Details::MultiHeadLatentAttention(attention_options));
                } else {
...
#endif // Nott_ATTENTION_BUILDER_HPP