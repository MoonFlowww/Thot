#ifndef THOT_REGULARIZATION_DETAILS_ORTHOGONALITY_HPP
#define THOT_REGULARIZATION_DETAILS_ORTHOGONALITY_HPP
...
#endif // THOT_REGULARIZATION_DETAILS_ORTHOGONALITY_HPP